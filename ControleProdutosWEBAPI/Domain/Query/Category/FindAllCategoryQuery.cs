...
{
    public class FindAllCategoryQuery : Pagination, IRequest<FindAllCategoryResponse>
    {
    }

    public class FindAllCategoryResponse : ResponseBase
    {
        public PagedList<CategoryDTO> Response { get; set; }
    }
}
