...
namespace ProductControlAPI.Domain.Query.Product
{
    public class FindProductByCategoryQuery : Pagination ,IRequest<FindProductByCategoryResponse>
    {
        public Guid CategoryId { get; set; }
    }

    public class FindProductByCategoryResponse : ResponseBase
    {
        public PagedList<ProductDTO> Response { get; set; }
    }
}
